...
${line("Privacy Policy", "/privacy", "What we collect and who processes it. A Google tag for Google Ads and Google Analytics sets cookies only if the visitor accepts, and nothing else tracks visitors.")}
